...
### Public trackers and how a torrent arrived

A member's instance can refuse public trackers. That decision needs to know
whether a torrent is private, and **where that answer comes from used to depend
